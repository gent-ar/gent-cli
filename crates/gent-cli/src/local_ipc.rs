...
use gent_protocol::{
    ...
    CONVERSATION_TIMELINE_CAPABILITY, EVENT_STREAM_CAPABILITY, Hello, PERMISSION_POLICY_CAPABILITY,
    PROVIDER_AUTH_CAPABILITY, REVIEWED_PLAN_CAPABILITY, RUNTIME_MAINTENANCE_CAPABILITY,
