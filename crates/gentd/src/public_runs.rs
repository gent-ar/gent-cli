...
pub(crate) type DaemonPublicRuns =
    Arc<PublicRunService<SqliteLedger, DriverRunRunner<SystemLauncher, SystemProcess>>>;

/// Builds the shipped observer service without inspecting or starting an executable.
#[must_use]
pub(crate) fn observer_service(coordinator: Coordinator<SqliteLedger>) -> DaemonPublicRuns {
